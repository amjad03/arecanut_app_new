        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text("Top Rated",style: TextStyle(fontSize: Dimensions.twenty),),
              Divider(color: Colors.black54, indent: Dimensions.forty, endIndent: Dimensions.forty,),
              // Padding(
              //   padding: EdgeInsets.only(top: Dimensions.ten),
              //   child: Container(
              //     width: double.maxFinite,
              ...
              //   ),
              // ),
              MachineCard(title: 'Arecanut Cutting Machine', rating: 4.5, totalRatings: 41, price: 5320, serviceProviderName: 'Some Name', image: "https://5.imimg.com/data5/ANDROID/Default/2022/1/RT/QX/DK/43977406/product-jpeg-250x250.jpg", address: 'Kotekere hubli Road, Sirsi',),
              MachineCard(title: 'Arecanut Cutting Machine', rating: 4.2, totalRatings: 32, price: 5500, serviceProviderName: 'Some Name', image: "https://tiimg.tistatic.com/fp/1/006/403/0-5-hp-single-phase-betel-nut-cutting-machine-with-cutting-speed-of-1440rpm-067.jpg", address: 'Kotekere hubli Road, Sirsi',),
              Container(
                padding: EdgeInsets.only(top: Dimensions.ten),
                width: double.maxFinite,
              ...
              Divider(color: Colors.black54, indent: Dimensions.forty, endIndent: Dimensions.forty,),
              Text("Arecanut Price",style: TextStyle(fontSize: Dimensions.twenty),),
              SizedBox(
                width: double.maxFinite,
                height: 300,
                child: LineGraph()
              ...
              SizedBox(
                ...
                child: Stack(
                  fit: StackFit.expand,
                  children: [
                    Image.network("https://images.unsplash.com/photo-1467803738586-46b7eb7b16a1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80",fit: BoxFit.cover,),
                    Container(color: Colors.black.withOpacity(0.3),),
                    Center(child: Text("Leading Arecanut \nService Company in \nSirsi.",style: TextStyle(color: Colors.white, fontSize: Dimensions.thirty, fontWeight: FontWeight.w900),textAlign: TextAlign.center,))
                  ],
                ),
              ),
              Divider(color: Colors.black54, indent: Dimensions.forty, endIndent: Dimensions.forty,),
...
class MachineCard extends StatefulWidget {
  const MachineCard({
    super.key, required this.title, required this.rating, required this.totalRatings, required this.price, required this.serviceProviderName, required this.image, required this.address,
  });
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(widget.title,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold, height: 2),maxLines: 1,overflow: TextOverflow.ellipsis,),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 15,),
                          Text("${widget.totalRatings} ratings",style: TextStyle(fontSize: 12),),
                        ],
                      ),
                      Text(widget.address,style: TextStyle(fontSize: 14, height: 1.5),maxLines: 1,overflow: TextOverflow.ellipsis,),
                      Text("Rs : ₹ ${formattedPrice} /-",style: TextStyle(fontSize: 18, height: 1.5),maxLines: 1,overflow: TextOverflow.ellipsis,),
                      Divider(),
                      Row(
                        children: [
                          Container(
