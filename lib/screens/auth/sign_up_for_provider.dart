...
class SignUpScreenForProvider extends StatefulWidget {
  ...
  @override
  State<SignUpScreenForProvider> createState() => _SignUpScreenForProviderState();
}
                ...
                child: Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Register as\nService Provider",style: TextStyle(fontSize: Dimensions.thirty,fontWeight: FontWeight.w500,fontFamily: 'Inter'),textAlign: TextAlign.center,),
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Email(Optional)",style: TextStyle(),),
                            SizedBox(height: Dimensions.ten,),
                            TextFormField(
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Experience (in years)",style: TextStyle(),),
                            SizedBox(height: Dimensions.ten,),
                            TextFormField(
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Total Machines",style: TextStyle(),),
                            SizedBox(height: Dimensions.ten,),
                            TextFormField(
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Total Workers",style: TextStyle(),),
                            SizedBox(height: Dimensions.ten,),
                            TextFormField(
                        ...
                        SizedBox(
                          ...
                          child: CustomButton(title: "Register",onPressed: () async {
                            if(_formKey.currentState!.validate()){
                              ...
                              String? res = await signUpWithEmailAndPasswordForProvider(emailController.text.trim(), passwordController.text.trim(), nameController.text.trim(), context);
                              if(res == 'true'){
                                // addUserData(nameController.text.trim(), emailController.text.trim() ,phoneController.text.trim());
                                addServiceProviderData(nameController.text, addressController.text, experienceController.text, machineCountController.text, workersCountController.text);
