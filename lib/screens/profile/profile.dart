    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          //         featuredPoints('Unlimited Free Wallpapers'),
          //         featuredPoints('Personalization features'),
          //         featuredPoints('Updated Collections of Wallpapers '),
          //         featuredPoints('Hundred\'s of Categories'),
          //         featuredPoints('Unlimited Premium Wallpapers'),
                ...
                children: [
                  Container(
                    ...
                    child: Align(
                        ...
                        child: Text('U',style: TextStyle(fontSize: Dimensions.thirty,color: Colors.white),)),
                  ),
                  SizedBox(width: Dimensions.width20,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text("User Name",style: TextStyle(fontSize: Dimensions.twenty,fontFamily: 'Inter'),),
                      Text("user_email@gmail.com",style: TextStyle(fontSize: Dimensions.fifteen,fontFamily: 'Inter'),),
                    ],
                  ),
                  SizedBox(height: Dimensions.width20,),
